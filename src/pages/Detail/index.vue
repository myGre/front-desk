    ...
    <section class="con">
      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          <!--放大镜效果-->
          <Zoom :skuImageList="skuImageObj" />
          <!-- 小图列表 -->
          <ImageList :skuImageList="skuImageObj" />
        </div>
        <!-- 右侧选择区域布局 -->
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              >
                <dt class="title">{{ skuSaleAttrValue.saleAttrName }}</dt>
            ...
            <div class="cartWrap">
              <div class="controls" @change="changeSku">
                <input autocomplete="off" class="itxt" v-model="skuNum" />
                <a
                  href="javascript:"
                  class="plus"
                  @click="skuNum < 10 ? skuNum++ : (skuNum = 10)"
                  >+</a
                >
                <a
                  href="javascript:"
...
export default {
  ...
  methods: {
    ...
    async addShop() {
      try {
        // 成功
        let result = await this.$store.dispatch("addShopGood", {
